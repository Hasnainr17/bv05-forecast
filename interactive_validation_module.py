...
def get_validation_section(location: str, start_date: str, end_date: str):
    """Returns HTML for validation section - ready for index.html"""
    ...
    <div class="card mt-4">
        ...
        <p style="text-align:center; color:#cbd5e1;">
            City: <strong>{location}</strong> | Period: <strong>{start_date}</strong> to <strong>{end_date}</strong>
        </p>
        
        <div style="display: flex; gap: 20px; margin-bottom: 30px; flex-wrap: wrap;">
            <div style="flex: 1; min-width: 280px; background: rgba(255,255,255,0.08); padding: 20px; border-radius: 20px; text-align: center;">
                <h4 style="margin:0 0 8px; color:#93c5fd;">Residential RMSPE</h4>
                <h2 style="margin:0; color:#60a5fa;">{rmsp_res}%</h2>
            </div>
            <div style="flex: 1; min-width: 280px; background: rgba(255,255,255,0.08); padding: 20px; border-radius: 20px; text-align: center;">
                <h4 style="margin:0 0 8px; color:#93c5fd;">C&amp;I RMSPE</h4>
